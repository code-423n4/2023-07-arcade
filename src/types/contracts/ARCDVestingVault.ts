...
export interface ARCDVestingVaultInterface extends utils.Interface {
  functions: {
...
export interface ARCDVestingVault extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ARCDVestingVaultInterface;
