...
export interface MockERC20ReentrancyInterface extends utils.Interface {
  functions: {
...
export interface MockERC20Reentrancy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockERC20ReentrancyInterface;
